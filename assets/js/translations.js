...
export const TRANSLATIONS = {
  en: {
    ...
    errorLoadingProducts: "Failed to load products. Please check your connection.",
    tryAgain: "Try Again",
    noProductsFound: "No products found",
    noTrendingProducts: "No trending products available right now",
  ...
  bn: {
    ...
    errorLoadingProducts: "প্রোডাক্ট লোড করতে সমস্যা হয়েছে। আপনার নেটওয়ার্ক কানেকশন চেক করুন।",
    tryAgain: "পুনরায় চেষ্টা করুন",
    noProductsFound: "কোনো প্রোডাক্ট পাওয়া যায়নি",
    noTrendingProducts: "বর্তমানে কোনো ট্রেন্ডিং প্রোডাক্ট নেই",
